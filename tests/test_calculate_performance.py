...
from app.services.frankfurter import calculate_performance, get_exchange_rate, validate_dates
...
class TestCalculatePerformance:
    ...
    def test_calculate_performance_positive_change(self):
        result = calculate_performance([5.00, 5.10, 5.25], "USD", "BRL", "2024-01-01", "2024-01-05")
    ...
    def test_calculate_performance_negative_change(self):
        result = calculate_performance([5.50, 5.20, 5.00], "USD", "BRL", "2024-01-01", "2024-01-05")
    ...
    def test_calculate_performance_zero_change_constant_rate(self):
        result = calculate_performance([1.00, 1.00, 1.00], "USD", "EUR", "2024-01-01", "2024-01-03")
    ...
    def test_calculate_performance_highest_and_lowest_rate(self):
        result = calculate_performance([5.00, 5.50, 4.80, 5.25], "USD", "BRL", "2024-01-01", "2024-01-05")
    ...
    def test_calculate_performance_rounding_to_4_decimal_places(self):
        result = calculate_performance([3.123456789, 3.987654321], "USD", "EUR", "2024-01-01", "2024-01-02")
    ...
    def test_get_exchange_rate_success(self, mock_get):
        mock_response = Mock()
        mock_response.json.return_value = {"amount": 1.0, "base": "EUR", "date": "2024-01-01", "rates": {"BRL": 5.35}}
    ...
    def test_calculate_performance_zero_initial_rate_prevents_division_error(self):
        result = calculate_performance([0.00, 5.00], "USD", "BRL", "2024-01-01", "2024-01-02")
        assert result["percentage_change"] == 0

...
from app.services.frankfurter import get_exchange_rate, validate_dates, calculate_performance
...
def get_currency_performance_route():
    ...
    try:
        ...
        url = f'{FRANKFURTER_BASE_URL}/{start_date}..{end_date}?base={base}&symbols={dest}'
        ...
        performance = calculate_performance(rate_values, base, dest, start_date, end_date)
